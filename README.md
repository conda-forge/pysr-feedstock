...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pysr-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15111&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pysr-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pysr` can be installed with:

```
conda install pysr
```

It is possible to list all of the versions of `pysr` available on your platform with:
